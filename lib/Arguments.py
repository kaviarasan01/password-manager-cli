class Argument:
    def __init__(self, args):
        self.command = []# which doesn't start with "-" everty thing is command
        self.options = []#which has "-"
        self.optionValues = {} #Dict/set here to avoid key errors
        self.args = args
        # print(self.args)
